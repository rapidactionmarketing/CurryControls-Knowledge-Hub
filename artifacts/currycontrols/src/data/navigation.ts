...
const ARTICLES: NavSection = {
  ...
  children: [
    ...
    n('PLC Articles', { menuLabel: 'PLC' }),
    n('SCADA Articles', { menuLabel: 'SCADA' }),
    n('Water Articles', { menuLabel: 'Water' }),
    n('Wastewater Articles', { menuLabel: 'Wastewater' }),
    n('Instrumentation Articles', { menuLabel: 'Instrumentation' }),
    n('Panels Articles', { menuLabel: 'Panels' }),
    n('Networking Articles', { menuLabel: 'Networking' }),
    n('Cybersecurity Articles', { menuLabel: 'Cybersecurity' }),
    n('Troubleshooting Articles', { menuLabel: 'Troubleshooting' }),
    n('Engineering Articles', { menuLabel: 'Engineering' }),
    n('Industry Articles', { menuLabel: 'Industry' }),
  ],
};
