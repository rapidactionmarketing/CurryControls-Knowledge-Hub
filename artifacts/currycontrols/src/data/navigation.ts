...
const ARTICLES: NavSection = {
  ...
  children: [
    ...
    g('PLC Articles', [n('Where the Logic Should Live: Controller, SCADA, or Relay'), n('The Backup That Would Not Restore')], { menuLabel: 'PLC' }),
    g('SCADA Articles', [n('What a Small Utility Should Ask Before Buying SCADA'), n('Alarms Nobody Answers')], { menuLabel: 'SCADA' }),
    g('Water Articles', [n('The Tank Level Trend Tells the Whole Story'), n('The Chlorine Residual Loop Is Slower Than You Think')], { menuLabel: 'Water' }),
    g('Wastewater Articles', [n('The Lift Station That Overflowed With Everything Working'), n('Inflow and Infiltration Shows Up in the Pump Runtime')], { menuLabel: 'Wastewater' }),
    g('Instrumentation Articles', [n('Calibration Is a Program, Not an Event'), n('When the Transmitter and the Gauge Disagree')], { menuLabel: 'Instrumentation' }),
    g('Panels Articles', [n('The Panel You Can Troubleshoot at Two in the Morning'), n('Heat Kills Panels Slowly')], { menuLabel: 'Panels' }),
    g('Networking Articles', [n('Fiber Between Buildings, Every Time'), n('One Flat Network Is One Big Fault Domain')], { menuLabel: 'Networking' }),
    g('Cybersecurity Articles', [n('The Cellular Router Is the Front Door'), n('The Vendor Laptop Is on Your Network Now')], { menuLabel: 'Cybersecurity' }),
    g('Troubleshooting Articles', [n('Measure Before You Replace'), n('The Intermittent Fault Is a Data Problem')], { menuLabel: 'Troubleshooting' }),
    g('Engineering Articles', [n('The Control Narrative Is the Contract'), n('As-Built Means Someone Walked the Panel')], { menuLabel: 'Engineering' }),
