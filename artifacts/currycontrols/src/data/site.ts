...
export const AFFILIATION = {
  ...
  paragraphs: [
    ...
    `${CONTACT.person} was employed by ${COMPANIES.curry} for over 25 years and left the company in 2021. Any association between him or ${SITE.name} and ${COMPANIES.curry} ended at that time. ${SITE.name} is no longer associated with ${COMPANIES.curry} in any way.`,
